              ...
              <form onSubmit={this.handleSubmit}>
                <List style={flexContainer}>
                    <ListItem>
                      <Card style={flexItem}>
                          <FormControl>
                              <InputLabel>Hi there! I'm _____?</InputLabel>
                              <Input id="greeting"
                    ...
                    <ListItem>
                        <Card style={flexItem}>
                            <FormControl>
                                <InputLabel>Do you have a family history of _____?</InputLabel>
                                <Input id="history"
                    ...
                    <ListItem>
                        <Card style={flexItem}>
                            <FormControl>
                                <InputLabel>Your course of treatment is _____.</InputLabel>
                                <Input id="diagnosis"
